  ...
  config = function()
    ...
    local sessions = {
      ...
      val = function()
        ...
        local sessions = lib.get_session_list(sessions_root)
        local val = {
          {
            type = 'text',
            val = 'Recent sessions',
        ...
        for i, session in ipairs(sessions) do
          ...
          local session_path = session.display_name
          table.insert(val, {
            type = 'button',
            val = '  \t' .. session.display_name,
            on_press = function()
            ...
            opts = {
              keymap = {
                'n',
                sc,
                ':SessionRestore ' .. session_path .. '<CR>',
                { desc = 'Restore session ' .. session.display_name },
              },
              position = 'center',
              width = 80,
              shortcut = sc,
